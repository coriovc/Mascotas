...
<!--nav-->
        <ul class="ulnav py-2 navbar-nav align-items-center fixed-top shadow shadow-lg ml-auto tct">
          <div class="row justify-content-center">
            ...
            <li class="nav-item mr-2"><a class="btn alert-secondary text-secondary rounded-pill  border-0" href="#!"><i class="mr-2 material-icons-round">person</i>Doctores</a>
            </li>
...
<!--formulario-->
        ...
        <!--imagen-->
        <div class="d-none d-md-block mt-2 lift-img-X-l"><img class="img-fluid" src="img/doctor.png" style="margin-right: -2rem; max-width: 11rem;" /></div>
        <!--imagen fin-->
        <div class="card border-0 shadow" style="width: 25rem;">
        <div class="display-5 card-header text-secondary tct">Formulario Doctor</div>    
        <div class="card-body tct">                
        <form action="php/insertar/insertar_doctor.php" method="post"> 
          <fieldset>
                      ...
                      <table class="table table-hover" width="100%">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td align="right">
                            <a class="btn btn-sm tct text-white bg-secondary rounded-pill lift-img-X-l" title="Editar: <?php echo $value->nombre_completo; ?>" href="php/modificar/modificar_doctor.php?id=<?php echo $value->id; ?>"><i class="material-icons-round">create</i>Editar</a>
...
<div class="footer">
    ...
    <div class="text-center tct text-white small">Designed by Victor corio CI-26.866.132 w© 2020 Copyright.</div>
